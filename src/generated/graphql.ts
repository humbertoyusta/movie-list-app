...
export type GetMovieListNameQueryVariables = Exact<{
    id: Scalars["Int"];
}>;

export type GetMovieListNameQuery = { getMovieList: { name: string } };
...
`;
export const GetMovieListNameDocument = /*#__PURE__*/ gql`
    query getMovieListName($id: Int!) {
        getMovieList(id: $id) {
            name
        }
    }
...
export function getSdk(
    ...
    return {
        ...
        getMovieListName(
            variables: GetMovieListNameQueryVariables,
            requestHeaders?: Dom.RequestInit["headers"]
        ): Promise<GetMovieListNameQuery> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<GetMovieListNameQuery>(
                        GetMovieListNameDocument,
                        variables,
                        { ...requestHeaders, ...wrappedRequestHeaders }
                    ),
                "getMovieListName",
